...
│ │ (.csv)      │ │    │ │ (Airflow DB) │ │    │ │                           │ │
│ └─────────────┘ │    │ │ Port: 5432   │ │    │ │ Gold Layer (Business)     │ │
└─────────────────┘    │ └──────────────┘ │    │ └─ tb_gd_customer_detail    │ │
                       └──────────────────┘    └───────────────────────────────┘
                                ↓
┌───────────────────────────────────────────────────────────────────────────────┐
...
│ │ │ - Schema Discovery                      │ │ User: admin@open...       │ │ │
│ │ │ - Data Profiling                        │ │ Pass: adminpostgres...    │ │ │
